MSD.Language["en"] = {
	...
	e_blank_default = "Leave black to use default",
	e_url = "Enter URL",
	...
	ent_show_pointer = "Show poiter above the entity",
...
MSD.Language[lng]["There is no quests avalible"] = "There is no quests avalible"
